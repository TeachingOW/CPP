...
# 6 "test_templates.cpp" 3 4
   (static_cast <bool> (
# 6 "test_templates.cpp"
   length>0
# 6 "test_templates.cpp" 3 4
...
# 6 "test_templates.cpp"
   "length>0"
# 6 "test_templates.cpp" 3 4
   , "test_templates.cpp", 6, __extension__ __PRETTY_FUNCTION__))
# 6 "test_templates.cpp"
                   ;
    T m=arr[0];
